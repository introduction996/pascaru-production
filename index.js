...
const linkLI = document.querySelector('#link-linkedin');
const linkIS = document.querySelector('#link-instagram');
const linkFB = document.querySelector('#link-facebook');
